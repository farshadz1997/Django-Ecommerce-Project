...
class UserLoginForm(AuthenticationForm):
    ...
    username = forms.CharField(widget=forms.TextInput(attrs={"placeholder": "Your Email", "id": "login-username"}))
...
class RegistrationForm(forms.ModelForm):
    ...
    password = forms.CharField(
        label="Password", required=True, widget=forms.PasswordInput(attrs={"placeholder": "Password"})
    )
    password2 = forms.CharField(
        label="Repeat password", required=True, widget=forms.PasswordInput(attrs={"placeholder": "Repeat password"})
    )
...
class PwdResetConfirmForm(SetPasswordForm):
    new_password1 = forms.CharField(
        label="New password", widget=forms.PasswordInput(attrs={"placeholder": "New Password", "id": "form-newpass"})
    )
    new_password2 = forms.CharField(
        label="Repeat password", widget=forms.PasswordInput(attrs={"placeholder": "New Password", "id": "form-new-pass2"})
    )
...
class UserEditForm(forms.ModelForm):
    ...
    user_name = forms.CharField(
        ...
        min_length=4,
        max_length=50,
        widget=forms.TextInput(attrs={"placeholder": "Username", "id": "form-username"}),
    )
    ...
    last_name = forms.CharField(
        ...
        min_length=3,
        max_length=50,
        widget=forms.TextInput(attrs={"placeholder": "Lastname", "id": "form-lastname"}),
    )
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.helper.layout = Layout(
            ...
            Div(
                ...
                HTML(
                    '<a href="{%url "accounts:delete_user"%}" class="btn btn-danger" style="padding: 10px 15px; margin-left: 10px">Delete Account</a>'
                ),
    ...
    def clean_user_name(self):
        ...
        if any(char in user_name for char in characters):
            raise forms.ValidationError("Username can not contain white space and special characters.")
...
class AddressForm(forms.ModelForm):
    ...
    address_line_1 = forms.CharField(
        label="Address", max_length=75, required=True, widget=forms.TextInput(attrs={"placeholder": "1234 Main St"})
    )
    address_line_2 = forms.CharField(
        required=False, max_length=75, widget=forms.TextInput(attrs={"placeholder": "Apartment, studio, or floor"})
    )
    ...
    state = forms.CharField(label="State/Province", max_length=50, required=True)
    postcode = forms.CharField(label="Zipcode", max_length=25, required=True)
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.helper.layout = Layout(
            Row(
                Column("first_name", css_class="form-group col-sm-6 mb-0"),
                Column("last_name", css_class="form-group col-sm-6 mb-0"),
            ),
            ...
            Row(
                Column("city", css_class="form-group col-sm-6 mb-0"),
                Column("state", css_class="form-group col-sm-6 mb-0"),
            ),
            Row(
                Column("phone", css_class="form-group col-sm-6 mb-0"),
